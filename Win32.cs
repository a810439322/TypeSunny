 ...
 */
   //     public static List <int> DelayCount = new List<int>();
     ...
     //       DelayCount.Add( milliSecond);
        ...
        static public void CtrlHome()
        {
            SimulateInputKeyDown(VK_LCONTROL);
            Delay(KEY_DELAY);
            SimulateInputKeyDown(VK_HOME);
            Delay(KEY_DELAY);
            SimulateInputKeyUp(VK_HOME);
            Delay(KEY_DELAY);
            SimulateInputKeyUp(VK_LCONTROL);
        }
        ...
        static public void CtrlF()
        {
            SimulateInputKeyDown(VK_LCONTROL);
            Delay(KEY_DELAY);
            SimulateInputKeyDown(VK_F);
            Delay(KEY_DELAY);
            SimulateInputKeyUp(VK_F);
            Delay(KEY_DELAY);
            SimulateInputKeyUp(VK_LCONTROL);
        ...
        static public void CtrlX()
        {
            SimulateInputKeyDown(VK_LCONTROL);
            Delay(KEY_DELAY);
            SimulateInputKeyDown(VK_X);
            Delay(KEY_DELAY);
            SimulateInputKeyUp(VK_X);
            Delay(KEY_DELAY);
            SimulateInputKeyUp(VK_LCONTROL);
