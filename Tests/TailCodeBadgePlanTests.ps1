...
Assert-Contains 'Copybook input offset follows full inline code display only' $copybookModeCode '_main.GetCodeDisplayImeOffset(fs)'
Assert-Contains 'Tracing input offset follows full inline code display only' $tracingModeCode '_main.GetCodeDisplayImeOffset(fs)'
