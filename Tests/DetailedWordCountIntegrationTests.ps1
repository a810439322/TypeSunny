...
Assert-Contains 'statistics window minimize button uses shared title style' $statsWindowXaml 'Style="{StaticResource SunnyTitleBarMinimizeButtonStyle}"'
Assert-Contains 'statistics window maximize button uses shared title style' $statsWindowXaml 'Style="{StaticResource SunnyTitleBarMaximizeButtonStyle}"'
Assert-Contains 'statistics window close button uses shared title style' $statsWindowXaml 'Style="{StaticResource SunnyTitleBarCloseIconButtonStyle}"'
